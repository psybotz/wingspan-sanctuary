  ...
  return (
    <main>
      ...
      >
        ...
        <Link href="/trips" className="mt-8 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg transition-transform duration-300 hover:scale-105">
          View Trip Schedules
        </Link>
      </section>
      ...
      <div className="py-16 text-center">
        ...
        <div className="inline-block bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
          <Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Ornithoptera.paradisea.arpal.m.jpg/1024px-Ornithoptera.paradisea.arpal.m.jpg" alt="Paradise Birdwing Butterfly" width={500} height={400} className="w-full max-w-sm mx-auto rounded-lg" />
          <h3 className="text-2xl font-bold mt-4"><Link href="/catalog/1">Ornithoptera paradisea</Link></h3>
          <p className="mt-2 text-gray-600">Known as the Paradise Birdwing, found in New Guinea.</p>
          <Link href="/catalog/1" className="mt-4 inline-block bg-white text-green-600 border-2 border-green-600 font-bold py-2 px-5 rounded-lg hover:bg-green-600 hover:text-white transition-colors duration-300">
            View Details
          </Link>
        </div>
      </div>
